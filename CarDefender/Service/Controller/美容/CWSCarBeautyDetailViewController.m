...
@interface CWSCarBeautyDetailViewController ()<UITableViewDelegate,UITableViewDataSource,CWSTableViewButtonCellDelegate>{
...
@implementation CWSCarBeautyDetailViewController
