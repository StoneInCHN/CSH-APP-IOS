...
@implementation FindParkingSpaceMarkView
...
-(void)creatMarkView{
    ...
    _leftPark = [[ParkMarkView alloc] initWithFrame:CGRectMake(SPACE*2 + SPACE/2, 0, kUSER_SCROLLVIEW_WIDTH, hight) Park:_dataArray.lastObject];
    [_scrollView addSubview:_leftPark];
    
    _middlePark = [[ParkMarkView alloc] initWithFrame:CGRectMake(width + SPACE, 0, kUSER_SCROLLVIEW_WIDTH, hight) Park:_dataArray[_currentNumber]];
    [_scrollView addSubview:_middlePark];
    
    _rightPark = [[ParkMarkView alloc] initWithFrame:CGRectMake(2*width - (SPACE/2), 0, kUSER_SCROLLVIEW_WIDTH, hight) Park:_dataArray[_currentNumber+1]];
